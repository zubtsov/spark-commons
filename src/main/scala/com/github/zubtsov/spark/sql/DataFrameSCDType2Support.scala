...
object DataFrameSCDType2Support {
  ...
  object implicits {
    ...
    implicit class DataFrameSCDType2SupportImpl(df: DataFrame) {
      ...
      /**
       * [[DataFrameSCDType2Support.periodicSnapshotToSCD2]]
       */
      def periodicSnapshotToSCD2(primaryKeyColNames: Seq[String],
        ...
        df.transform(DataFrameSCDType2Support.periodicSnapshotToSCD2(primaryKeyColNames, scdType2ColNames, businessDateColName, startDateColName, endDateColName))
      }
    }
  }
